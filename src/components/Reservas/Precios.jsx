  ...
  <div className="py-8 px-4 mx-auto max-w-screen-xl lg:py-16 lg:px-6">
      ...
      <div className="space-y-8 lg:grid lg:grid-cols-3 sm:gap-6 xl:gap-10 lg:space-y-0">
          <div className="flex flex-col p-6 mx-auto max-w-lg text-center text-gray-900 bg-white rounded-lg border border-gray-100 shadow dark:border-gray-600 xl:p-8 dark:bg-gray-800 dark:text-white">
              ...
              <p className="font-light text-gray-500 sm:text-lg dark:text-gray-400">Nuestra suite común mas usada por los residentes</p>
          ...
          <div className="flex flex-col p-6 mx-auto max-w-lg text-center text-gray-900 bg-white rounded-lg border border-gray-100 shadow dark:border-gray-600 xl:p-8 dark:bg-gray-800 dark:text-white">
              ...
              <p className="font-light text-gray-500 sm:text-lg dark:text-gray-400">Lo mejor para nuestros clientes VIP, los dotaremos con:</p>
              <div className="flex justify-center items-baseline my-8">
          ...
          <div className="flex flex-col p-6 mx-auto max-w-lg text-center text-gray-900 bg-white rounded-lg border border-gray-100 shadow dark:border-gray-600 xl:p-8 dark:bg-gray-800 dark:text-white">
              ...
              <p className="font-light text-gray-500 sm:text-lg dark:text-gray-400">¿Quieres pasar un dia como uno de los presidentes? ¡entonces esta es tu suite!</p>
              <div className="flex justify-center items-baseline my-8">
