...
<div className="bg-gradient-to-r from-green-600 to-green-400 px-4 py-5 sm:px-6">
  <div className="flex items-center">
    ...
    <h1 className="text-2xl font-semibold text-white ml-4">
      {`${userData?.nombre} ${userData?.apellido}` || "Proximamente / En Desarrollo"}
    </h1>
  </div>
</div>
        ...
        <div className="px-4 py-5 sm:p-6">
          <div className="flex items-center mb-4">
            ...
            <span className="ml-2">{userData?.correo || "Proximamente / En Desarrollo"}</span>
          </div>
          <div className="flex items-center mb-4">
            <svg
              className="h-6 w-6 text-purple-500 mr-2"
            ...
            <span className="ml-2">{userData?.telefono || "Telefóno sin Registrar"}</span>
          </div>
          <div className="flex items-center">
            <svg
              className="h-6 w-6 text-purple-500 mr-2"
            ...
            <span className="ml-2">{userData?.descripcion || "Descripción sin Registrar"}</span>
          </div>
        </div>
      </div>
    </div>
