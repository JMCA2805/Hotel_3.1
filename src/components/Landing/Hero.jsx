    ...
    return (
        ...
        <div className="grid max-w-screen-xl px-4 py-8 mx-auto lg:gap-8 xl:gap-0 lg:py-16 lg:grid-cols-12">
            ...
            <div className="mr-auto place-self-center lg:col-span-7">
                ...
                <a href="#" className="inline-block px-3 py-2 rounded-md text-white font-bold bg-Moradote focus:outline-none focus:text-white hover:border-2 hover:border-VerdeO ">
                    Reservar
                </a> 
            </div>  
            {/* Imagen */}  
